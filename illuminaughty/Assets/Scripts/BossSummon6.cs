...
public class BossSummon6 : MonoBehaviour
{
    public Animator anim;
    public BoxCollider2D colider, entry, cheatBlocker;
    public string bossName;
    public int bossHealth;
    public Transform cameraMoveZone;
    public GameObject fightCanvas;
    public int summonSound;
    public CenaFist boss;
    ...
    public void SummonEnd()
    {
        ...
        {
            boss.turn = true;
            boss.startBuffCount = boss.startBuffTime;
        }
    }
